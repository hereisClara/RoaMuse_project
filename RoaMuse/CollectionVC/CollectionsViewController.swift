...
//            sender.backgroundColor = .clear
            ...
            if let previousIndex = selectedFilterIndex {
                ...
                if previousIndex < filterButtons.count {
                    ...
                    print("Warning: previousIndex 超出 filterButtons 的範圍。")
                }
            }
